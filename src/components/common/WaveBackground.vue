<template>
  ...
  >
    <svg
      class="relative block w-full h-[80px] md:h-[120px]"
    ...
    >
      <defs>
        <linearGradient id="wave-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" style="stop-color: hsl(280, 90%, 60%); stop-opacity: 1" />
          <stop
            offset="50%"
            style="stop-color: hsl(190, 90%, 50%); stop-opacity: 1"
          />
          <stop
            offset="100%"
            style="stop-color: hsl(330, 85%, 60%); stop-opacity: 1"
          />
        </linearGradient>
      </defs>
      <path
